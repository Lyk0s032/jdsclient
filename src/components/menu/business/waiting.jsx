...
export default function Waiting(props){
    ...
    // setInterval(dispatch(actions.AxiosGetMesa(storeP.id, params.ref, false)), 15000)
    return (
            ...
            <div className='header'>
                <div className='price'>
                    ...
                    <div className='button'>
                        <button>Listo en apróximandamente 10 minutos.</button>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                            {
                                mesa.car[0].items.map((item) => {
                                    ...
                                    <tr>
                                        ...
                                        <td>{ item.chosee.estado == 'waiting' ? 'Preparando...' 
                                               : item.chosee.estado == 'delivered' ? 'Entregado'
                                               : 'Otro...'
                                            }</td>
                                        <td></td>
                                    </tr>
